...
const std::unordered_map<std::size_t, const char*> crequest::codeResponse({
	{ 0,"" },
	...
	{ 300,"Multiple Choices" },	{ 301,"Moved Permanently" }, { 302,"Moved Temporarily" }, { 302,"Found" }, { 303,"See Other" }, { 304,"Not Modified" },
	...
	{ 411,"Length Required" }, { 412,"Precondition Failed" }, { 413,"Payload Too Large" }, { 414,"URI Too Long" }, { 415,"SAPI interface not found" },
	{ 416,"Range Not Satisfiable" }, { 417,"Expectation Failed" }, { 418,"I’m a teapot" }, { 419,"Authentication Timeout" }, { 421,"Misdirected Request"},
	{ 422,"Unprocessable Entity"}, { 423,"Locked"}, { 424,"Failed Dependency"}, { 426,"Upgrade Required"}, { 428,"Precondition Required"},
	{ 429,"Too Many Requests"}, { 431,"Request Header Fields Too Large"}, { 449,"Retry With"}, { 451,"Unavailable For Legal Reasons"}, { 499,"Client Closed Request"},
	...
	{ 511,"Network Authentication Required"}, { 520,"Unknown Error"}, { 521,"Web Server Is Down"}, { 522,"Connection Timed Out"}, { 523,"Origin Is Unreachable"},
